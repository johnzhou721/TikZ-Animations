...
Description: \
lua-tikz3dtools is a toolkit for making 3D illustrations with Ti*k*Z. 
It can render multiple parametric objects and labels at once, and 
clip planes by rectangular prisms. Eventually, I want to add triangle
clipping.
