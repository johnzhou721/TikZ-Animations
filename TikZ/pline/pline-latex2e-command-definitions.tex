% pline-latex2e-command-definitions.tex
\newcommand{\drawpoint}[2][]{
    \begingroup 
        ...
        \node at (@) [
            ...
            ,outer sep = 0pt
            ,fill
            ,/pline/geometric-vector/.search also = {/tikz}
            ,/pline/geometric-vector/.cd
            ,#1
        ] {};
    \endgroup
}
...
\newcommand{\appendprism}[1][]{
    \begingroup
    \tikzset{
        /pline/clipped-subspace/plane/.search also = {/pline/clipped-subspace},
        /pline/clipped-subspace/plane/.cd,
        #1
    }
