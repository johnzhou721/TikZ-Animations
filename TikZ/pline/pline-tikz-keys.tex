% tikzkeys.tex
\tikzset{
    /pline/.is family % abbreviated "td"
    ,/pline/.cd 
        ,/pline/clipped-subspace/.cd % abbreviated "cs"
            ...
            ,/pline/clipped-subspace/plane/.cd % abbreviated "p"
            ...
            ,/pline/clipped-subspace/line/.cd % abbreviated "l"
                % direction vector
            ...
            ,/pline/clipped-subspace/point/.cd % abbreviated "pt"
        ,/pline/parametric/.cd % abbreviated "p"
            ,/pline/parametric/curve/.cd % abbreviated "c"
                ...
                ,name = George
                ,transformation = {identity_matrix()}
            ,/pline/parametric/surface/.cd % abbreviated "surf"
                ...
                ,name = Bob
                ,transformation = {identity_matrix()}
            ,/pline/parametric/solid/.cd % abbreviated "s"
        ...
        ,/pline/ode/.cd % abbreviated "ode"
        ,/pline/geometric-vector/.cd % abbreviated "gm"
