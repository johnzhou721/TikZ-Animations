...
\begin{document}
    ...
    \chapter{Introduction}
        ...
        \section{
            ...
            matrix transformations. pline is built to render 
...
\end{minted}
    ...
    \chapter{The Math Module}
        ...
        \mintinline{lua}{math.cos()}. pline defines a growing
...
\end{minted}
            \begin{figure}
                ...
                \label{fig:3-1-1}
            \end{figure}
            pline is also capable of handling division by zero
...
\end{minted}
            \begin{figure}
                ...
                \label{fig:3-1-2}
            \end{figure}
            pline is meant to be compatible with Ti\textit{k}Z, and
            they are meant to be used together---at least for now.
            Maybe one day pline will have enough capabilities to 
